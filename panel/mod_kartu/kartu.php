        ...
        <div class='box box-solid'>
            <div class='box-header with-border'>
                ...
                <div class='box-tools pull-right '>
                    ...
                    <!-- <button class='btn btn-sm btn-flat btn-success' onclick="frames['frameresult2'].print()"><i class='fa fa-print'></i> Print 2</button>
                    <button class='btn btn-sm btn-flat btn-success' onclick="frames['frameresult3'].print()"><i class='fa fa-print'></i> Print 3</button> -->
...
<!-- <iframe id='loadframe2' name='frameresult2' src='mod_kartu/cetak_kartu.php' style='width:1000px;height:2000px'></iframe>
<iframe id='loadframe3' name='frameresult3' src='mod_kartu/cetak_kartub.php' style='display:none;'></iframe> -->